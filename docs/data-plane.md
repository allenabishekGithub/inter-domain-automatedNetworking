...
distinction matters for [E01](experimental-validation.md#e01--domain-authority-identities-and-controller-boundaries).
...
authorization are [Phase 2](implementation-roadmap.md#phase-2--local-controller-mcp-server-and-transaction-safety)
...
See the [implementation roadmap](implementation-roadmap.md) for the adapter and
federation work, and the [experimental validation plan](experimental-validation.md)
